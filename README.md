...
# REQUIREMENTS 
  ...
  4. BOT_TOKEN
  5. BG_IMAGE (Your Costom photo in MENU)
  6. SUDO USER(YOUR MAIN ACCOUNT ID)
  7. MOST IMPORTANT A SPARE ACCOUNT 
  8. USE DURATION_LIMIT AS IT IS FOR SMOOTH PERFORMANCE 
