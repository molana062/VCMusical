        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                if message.chat.title.startswith("Channel Music: "):
                    await lel.edit(
                        "<b>Remember to add @LovishMusic_bot to your channel</b>",
                    )
                    pass
                try:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id, "@LovishMusic_bot HERE IN this group for playing music in VC"
                    )
                    await lel.edit(
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    await USER.join_chat(invitelink)
                    await USER.send_message(
                        message_.chat.id, "@LovishMusic_bot Is here In this group for playing music in VC"
                    )
                    await lel.edit(
                        "<b>@LovishMusic_bot joined your chat</b>",
                    )
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    await USER.join_chat(invitelink)
                    await USER.send_message(
                        message_.chat.id, "@LovishMusic_bot joined this group for playing music in VC"
                    )
                    await lel.edit(
                        "<b>@LovishMusic_bot joined your chat</b>",
                    )
    ...
    try:
        ...
        await lel.edit(
            "<i> @LovishMusic_bot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return
    requested_by = message_.from_user.first_name
    chat_id = message_.chat.id
