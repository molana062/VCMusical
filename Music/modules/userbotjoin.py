...
async def addchannel(client, message):
    ...
    try:
        ...
        await message.reply_text(
            ...
            "\n\nOr manually add @sheebaqueenmusicbot to your Group and try again</b>",
        )
        return
    await message.reply_text(
...
@Client.on_message(filters.command(["userbotjoinchannel","cubjoin"]) & ~filters.private & ~filters.bot)
@authorized_users_only
@errors
